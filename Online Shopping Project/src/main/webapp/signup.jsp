		...
		<div class='signup'>
			<form action="signupAction.jsp" method="post">
				<input type="text" name="name" placeholder="Enter Your Name"
					...
					placeholder="Enter Your Email" required /> <input type="number"
					name="mobile" placeholder="Enter Your Phone No." required /> <select
					...
					placeholder="Enter Your Password" required /> <input type="submit"
